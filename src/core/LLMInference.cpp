...
void selective_log_callback(ggml_log_level level, const char * text, void * user_data) {
         // Only print messages that are warnings or errors.
...
LLMInference::loadModel(const char *model_path, float minP, float temperature, bool storeChats, long contextSize,
    ...
    llama_log_set(selective_log_callback,nullptr);
